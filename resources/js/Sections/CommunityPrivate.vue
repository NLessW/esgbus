...
<template>
    ...
    >
        ...
        >
            <tr>
                <th scope="col" class="px-6 py-3 min-w-10">NO</th>
                <th scope="col" class="px-6 py-3 min-w-96">제목</th>
                <th scope="col" class="px-6 py-3 min-w-24">이름</th>
                <th scope="col" class="px-6 py-3 min-w-24">등록일</th>
            </tr>
        </thead>
        <tbody>
            <tr
